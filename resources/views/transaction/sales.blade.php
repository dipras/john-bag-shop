...
<div class="px-2 py-6 flex flex-col gap-4">
    ...
    @endif
    <h1 class="text-4xl text-[#434B6A] font-medium">Transaksi Penjulan</h1>
...
<div style="background-color: rgba(0,0,0,0.2);" class="w-full h-full absolute top-0 left-0 flex flex-row justify-center items-center p-2 hidden" id="cart-modal">
